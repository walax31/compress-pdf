...
import { CompressionSettingsProps } from "./types";

const CompressionSettings = (props: CompressionSettingsProps) => {
  return (
    <div className="flex items-center justify-center flex-col">
      <div className="p-4 border-2 border-primary-400  rounded-lg bg-primary-200 w-full max-w-[721px] flex flex-col space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2">
            ...
            <input
              ...
              min="1"
              max="100"
              value={props.imageQuality === 0 ? "" : props.imageQuality}
